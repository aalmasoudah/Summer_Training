...
def build_pdf_question_prompt(pdf_text, student_question):
    """Combine limited PDF text with the student's question."""

    limited_pdf_text = pdf_text[:MAX_PDF_CHARACTERS]

    return f"""
You are answering a student's question using uploaded course material.

Instructions:
- Answer primarily from the PDF text provided below.
- Treat the PDF as the main source for your answer.
...
question = st.text_area(
    "Enter your question",
    placeholder="Ask a question about the uploaded course PDF..."
)
